...
import { BookOpen, Sparkles, Compass, Feather, Eye, Lightbulb, Target, CheckCircle2 } from 'lucide-react';
import './Carousel.css';
...
const DEFAULT_ITEMS: CarouselItemData[] = [
  ...
  },
  {
    ...
    icon: <Feather className="carousel-icon" />,
    badge: 'OBJETIVO 04',
    footer: 'Habilidad Práctica'
  },
  {
  ...
  return (
    ...
    >
      <div className={`carousel-item-header ${round ? 'round' : ''}`}>
        {item.badge && <span className="carousel-badge">{item.badge}</span>}
        <span className="carousel-icon-container">{item.icon ?? <CheckCircle2 className="carousel-icon" />}</span>
      </div>
